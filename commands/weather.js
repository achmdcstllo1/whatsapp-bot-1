...
const execute = async (client, msg, args) => {
    ...
    var options = {
        ...
        headers: {
          ...
          'x-rapidapi-key': '5a239d6287mshb59458c2637bf91p1f5e26jsnf671c43b693f'
        }
      };
      ...
      axios.request(options).then(function (response) {
          ...
          //msg.reply(MessageMedia.fromFilePath('./elsa/Weather.jpg'), {caption: `${weather}\n\n*© Elsa Wa-Bot*`});
          //msg.reply(MessageMedia.fromFilePath('./elsa/weather.gif'));
